...
const QUANTITY_PREVIEW_CARDS = 5;
const QUANTITY_RATED_CARDS = 2;
const QUANTITY_COMMENTED_CARDS = 2;

const filmsListArray = [
...
const createMainNavigationElement = () => {
  return (
...
renderFilmsCard(filmsListBlock, filmsListArray, QUANTITY_PREVIEW_CARDS);
renderFilmsCard(filmsRatedBlock, ratedFilmsArray, QUANTITY_RATED_CARDS);
renderFilmsCard(filmsCommentedBlock, commentedFilmsArray, QUANTITY_COMMENTED_CARDS);
